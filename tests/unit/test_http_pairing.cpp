...
TEST_P(PairingTest, Run) {
  ...
  // phase 4
  // Note: clientpairingsecret() no longer accepts add_cert queue parameter;
  // the cert-queue verification block was removed when the production signature
  // changed. Updated to match the current nvhttp.h declaration.
